...
export default function CreateTask() {
  ...
  useEffect(() => {
    axios
      .get(`https://csis3380-deploytest.vercel.app/activity/${id}`)
      .then((response) => {
  ...
  const onSubmit = (e) => {
    ...
    console.log(`https://csis3380-deploytest.vercel.app/activity/update/${id}`);
    // console.log(e)

    axios
      .post(`https://csis3380-deploytest.vercel.app/activity/update/${id}`, activityvar)
      .then((res) => {
        window.location = '/';
      });
  };
